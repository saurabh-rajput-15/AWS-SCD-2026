...
CREATE POLICY "Allow public read merch_inventory" ON public.merch_inventory FOR SELECT TO anon, authenticated, service_role USING (true);
CREATE POLICY "Allow service role write merch_inventory" ON public.merch_inventory FOR ALL TO service_role USING (true) WITH CHECK (true);
